...
AssetLoader.add.image('sprites/crossy-road-logo.png');AssetLoader.add.script('scripts/three.min.js');// Still add the load here to make sure it's done before we move on
