import{r as t,j as e}from"./index-DFVDn7O1.js";import{G as L}from"./gamepad-2-BRXhPPG8.js";import{G as I}from"./grid-2x2-BBY8fBMe.js";import{c as M,X as b,S as D,P as k,V as O}from"./x-DsfhEe0S.js";import{S as T}from"./settings-DKp7t7LX.js";import{M as Y,H as A}from"./menu-D0sgf27C.js";import{S as _}from"./sparkles-C6qXgTOV.js";import{C as q}from"./chevron-left-xIZlUFhO.js";import{P as V}from"./pause-B55YClLI.js";import{C as W}from"./chevron-right-DrteR-Fq.js";const E=[["circle",{cx:"8",cy:"18",r:"4",key:"1fc0mg"}],["path",{d:"M12 18V2l7 4",key:"g04rme"}]],P=M("music-2",E);const Q=[["path",{d:"M16.247 7.761a6 6 0 0 1 0 8.478",key:"1fwjs5"}],["path",{d:"M19.075 4.933a10 10 0 0 1 0 14.134",key:"ehdyv1"}],["path",{d:"M4.925 19.067a10 10 0 0 1 0-14.134",key:"1q22gi"}],["path",{d:"M7.753 16.239a6 6 0 0 1 0-8.478",key:"r2q7qm"}],["circle",{cx:"12",cy:"12",r:"2",key:"1c9p78"}]],J=M("radio",Q),d="/__mockup/images/aerodynamix/",X=[["run-3.jpg","Run 3","Action","fast"],["drive-mad.jpg","Drive Mad","Action","new"],["retro-bowl.jpg","Retro Bowl","Classic","hot"],["slope.jpg","Slope","Action","fast"],["mc.png","Minecraft","Chill","sandbox"],["supersmashflash.jpg","Super Smash Flash","Action","hot"],["papaspizzeria.png","Papa's Pizzeria","Chill","cozy"],["papasfreezeria.png","Papa's Freezeria","Chill","cozy"],["papas-pancakeria.png","Papa's Pancakeria","Chill","cozy"],["papas-bakeria.png","Papa's Bakeria","Chill","cozy"],["meat-boy.png","Meat Boy","Action","hard"],["newgrounds-rumble.png","Newgrounds Rumble","Action","arcade"],["we-become-what-we-behold.png","We Become What We Behold","Story","odd"],["bad-time-simulator.png","Bad Time Simulator","Action","hard"],["deltarune.png","Deltarune","Story","story"],["adventure-capitalist.png","Adventure Capitalist","Chill","idle"],["fridaynightfunkin.png","Friday Night Funkin'","Action","rhythm"],["run-2.png","Run 2","Classic","fast"],["picoschool.png","Pico's School","Story","odd"],["worldshardestgame.png","World's Hardest Game","Classic","hard"],["sandboxels.png","Sandboxels","Chill","sandbox"],["alien-hominid.png","Alien Hominid","Action","arcade"],["subway-surfers-sf.jpg","Subway Surfers San Francisco","Action","fast"],["hobo-1.png","Hobo 1","Classic","arcade"],["hobo-2.png","Hobo 2","Classic","arcade"],["hobo-3.png","Hobo 3","Classic","arcade"],["hobo-4.png","Hobo 4","Classic","arcade"],["hobo-5.png","Hobo 5","Classic","arcade"],["hobo-6.png","Hobo 6","Classic","arcade"],["hobo-7.png","Hobo 7","Classic","arcade"],["gladihoppers.jpg","Gladihoppers","Action","arcade"],["fruit-ninja.png","Fruit Ninja","Action","fast"],["binding-of-isaac.png","Binding of Isaac","Story","dark"],["crossy-road.png","Crossy Road","Classic","fast"],["cookie-clicker.png","Cookie Clicker","Chill","idle"],["duck-life.png","Duck Life","Chill","cozy"],["geometry-dash-lite.jpg","Geometry Dash Lite","Action","rhythm"],["doom.png","Doom","Action","classic"],["doki-doki-literature-club.jpg","Doki Doki Literature Club","Story","story"],["baldis-basics-classic-remastered.png","Baldi's Basics","Story","odd"],["stickmin-breaking-bank.jpg","Breaking the Bank","Story","odd"],["stickmin-escaping-prison.avif","Escaping the Prison","Story","story"],["stickmin-stealing-diamond.avif","Stealing the Diamond","Story","story"],["stickmin-infiltrating-airship.avif","Infiltrating the Airship","Story","story"],["stickmin-fleeing-complex.avif","Fleeing the Complex","Story","story"],["greatest-game-square.svg","The Greatest Game","Classic","wild"],["nubbys-number-factory.jpg","Nubby's Number Factory","Chill","odd"]],i=X.map(([o,p,n,g])=>({file:o,name:p,genre:n,tag:g})),K=[i[0],i[1],i[5],i[6],i[2],i[36]],U=[{label:"Games",icon:L},{label:"Apps",icon:I},{label:"Media Player",icon:P},{label:"Connect",icon:J},{label:"Settings",icon:T}];function ce(){const[o,p]=t.useState(""),[n,g]=t.useState("Games"),[m,j]=t.useState(!1),[s,$]=t.useState(!1),[u,G]=t.useState(["Run 3","Retro Bowl"]),[l,h]=t.useState(null),[f,w]=t.useState(i[0]),[x,C]=t.useState(!1),[F,z]=t.useState(!0),[R,B]=t.useState(72),y=t.useMemo(()=>{const a=o.trim().toLowerCase();return i.filter(r=>{const c=!a||r.name.toLowerCase().includes(a)||r.genre.toLowerCase().includes(a),v=!s||u.includes(r.name);return c&&v})},[u,o,s]),H=a=>{G(r=>r.includes(a)?r.filter(c=>c!==a):[...r,a])},N=a=>{w(a),h(a),C(!0)},S=a=>{const c=(i.findIndex(v=>v.name===f.name)+a+i.length)%i.length;w(i[c])};return e.jsxs("main",{className:"reference-arcade",children:[e.jsx("style",{children:`
        .reference-arcade {
          --ink: #08090b;
          --panel: #111317;
          --panel-hi: #191c20;
      ...
      `}),e.jsxs("header",{className:"arcade-topbar",children:[e.jsx("button",{className:"arcade-brand",type:"button",onClick:()=>g("Games"),"aria-label":"Aerodynamix home",children:e.jsx("img",{src:`${d}logo.gif`,alt:"Aerodynamix"})}),e.jsx("nav",{className:`arcade-nav ${m?"open":""}`,"aria-label":"Aerodynamix navigation",children:U.map(({label:a,icon:r})=>e.jsxs("button",{className:n===a?"active":"",type:"button",onClick:()=>{g(a),j(!1)},"aria-label":a,"aria-pressed":n===a,children:[e.jsx(r,{size:17,strokeWidth:2.2}),e.jsx("span",{className:"arcade-nav-label",children:a})]},a))}),e.jsx("button",{className:"arcade-menu-button",type:"button",onClick:()=>j(a=>!a),"aria-expanded":m,"aria-label":m?"Close navigation":"Open navigation",children:m?e.jsx(b,{size:18}):e.jsx(Y,{size:18})})]}),e.jsxs("section",{className:"arcade-heading","aria-labelledby":"arcade-title",children:[e.jsx("h1",{id:"arcade-title",children:n.toLowerCase()}),e.jsxs("p",{children:[e.jsx("strong",{children:"●"})," loaded ",i.length," games · local collection"]})]}),e.jsx("section",{className:"spotlight","aria-label":"Quick picks",children:K.map(a=>e.jsx("button",{className:"spotlight-card",type:"button",onClick:()=>N(a),"aria-label":`Launch ${a.name}`,children:e.jsx("img",{src:`${d}${a.file}`,alt:a.name})},a.name))}),e.jsxs("section",{className:"arcade-controls","aria-label":"Find a game",children:[e.jsxs("label",{className:"arcade-search",children:[e.jsx(D,{size:15,"aria-hidden":"true"}),e.jsx("input",{type:"search",value:o,onChange:a=>p(a.target.value),placeholder:"find what you want…","aria-label":"Find a game"}),o&&e.jsx("button",{type:"button",onClick:()=>p(""),"aria-label":"Clear search",children:e.jsx(b,{size:14})})]}),e.jsxs("button",{className:`saved-toggle ${s?"active":""}`,type:"button",onClick:()=>$(a=>!a),"aria-pressed":s,children:[e.jsx(A,{size:13,fill:s?"currentColor":"none"}),"saved ",u.length]})]}),e.jsxs("section",{className:"library","aria-labelledby":"library-title",children:[e.jsxs("div",{className:"library-meta",children:[e.jsxs("span",{id:"library-title",children:[e.jsx("strong",{children:y.length})," results"]}),e.jsxs("span",{children:[e.jsx(_,{size:10,"aria-hidden":"true"})," picks for you"]})]}),e.jsx("div",{className:"game-grid",children:y.length?y.map(a=>{const r=u.includes(a.name);return e.jsxs("article",{className:"game-card",children:[e.jsx("img",{src:`${d}${a.file}`,alt:`${a.name} game artwork`,loading:"lazy"}),e.jsx("button",{className:`favorite-button ${r?"is-favorite":""}`,type:"button",onClick:()=>H(a.name),"aria-label":r?`Remove ${a.name} from saved games`:`Save ${a.name}`,"aria-pressed":r,children:e.jsx(A,{size:12,fill:r?"currentColor":"none"})}),e.jsxs("button",{className:"game-launch",type:"button",onClick:()=>N(a),"aria-label":`Launch ${a.name}`,children:[e.jsx("span",{className:"game-play",children:e.jsx(k,{size:11,fill:"currentColor"})}),e.jsx("span",{className:"game-name",children:a.name}),e.jsxs("span",{className:"game-genre",children:[a.genre," · ",a.tag]})]})]},a.name)}):e.jsxs("div",{className:"empty-library",children:[e.jsx("strong",{children:"nothing in this orbit"}),"Try another search or clear the saved filter."]})})]}),F?e.jsxs("aside",{className:"arcade-player","aria-label":"Persistent media player",children:[e.jsxs("div",{className:"track-meta",children:[e.jsx("img",{className:"track-art",src:`${d}${f.file}`,alt:""}),e.jsxs("div",{className:"track-copy",children:[e.jsx("div",{className:"track-title",children:f.name}),e.jsx("div",{className:"track-subtitle",children:x?"now playing locally":"media player · ready"})]})]}),e.jsxs("div",{className:"player-controls",children:[e.jsx("button",{type:"button",onClick:()=>S(-1),"aria-label":"Previous track",children:e.jsx(q,{size:17})}),e.jsx("button",{className:"play-toggle",type:"button",onClick:()=>C(a=>!a),"aria-label":x?"Pause":"Play",children:x?e.jsx(V,{size:14,fill:"currentColor"}):e.jsx(k,{size:14,fill:"currentColor"})}),e.jsx("button",{type:"button",onClick:()=>S(1),"aria-label":"Next track",children:e.jsx(W,{size:17})})]}),e.jsxs("div",{className:"player-tools",children:[e.jsxs("span",{className:"player-time",children:[x?"0:18":"0:00"," / 2:47"]}),e.jsx(O,{size:14,"aria-hidden":"true"}),e.jsx("input",{type:"range",min:"0",max:"100",value:R,onChange:a=>B(Number(a.target.value)),"aria-label":"Volume"}),e.jsx("button",{className:"player-close",type:"button",onClick:()=>z(!1),"aria-label":"Close media player",children:e.jsx(b,{size:15})})]})]}):e.jsx("button",{className:"reopen-player",type:"button",onClick:()=>z(!0),"aria-label":"Open media player",children:e.jsx(P,{size:18})}),l&&e.jsx("div",{className:"launch-modal-backdrop",role:"presentation",onClick:()=>h(null),children:e.jsxs("section",{className:"launch-modal",role:"dialog","aria-modal":"true","aria-labelledby":"launch-title",onClick:a=>a.stopPropagation(),children:[e.jsx("img",{src:`${d}${l.file}`,alt:""}),e.jsxs("div",{className:"launch-modal-copy",children:[e.jsx("small",{children:"local launch ready"}),e.jsx("h2",{id:"launch-title",children:l.name}),e.jsxs("p",{children:[l.genre," · ",l.tag,e.jsx("br",{}),"No account. No waiting. Just play."]}),e.jsxs("button",{className:"modal-launch",type:"button",onClick:()=>h(null),children:[e.jsx(k,{size:13,fill:"currentColor"})," enter game"]})]}),e.jsx("button",{className:"modal-close",type:"button",onClick:()=>h(null),"aria-label":"Close launch dialog",children:e.jsx(b,{size:14})})]})})]})}export{ce as ReferenceArcade};
