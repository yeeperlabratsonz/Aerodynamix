import{r as i,j as a}from"./index-DFVDn7O1.js";import{S as E}from"./settings-2-Dn881918.js";import{c as T,X as y,P as u,S as z,V as q}from"./x-DsfhEe0S.js";import{M as H,H as L}from"./menu-D0sgf27C.js";import{C as I}from"./check-xcwN1ccB.js";import{S as O}from"./sparkles-C6qXgTOV.js";import{S as Y}from"./sliders-horizontal-CjUMQHQo.js";import{G as V}from"./grid-2x2-BBY8fBMe.js";import{C as W}from"./chevron-left-xIZlUFhO.js";import{P as _}from"./pause-B55YClLI.js";import{C as Q}from"./chevron-right-DrteR-Fq.js";const X=[["path",{d:"m16 6 4 14",key:"ji33uf"}],["path",{d:"M12 6v14",key:"1n7gus"}],["path",{d:"M8 8v12",key:"1gg7y9"}],["path",{d:"M4 4v16",key:"6qkkli"}]],J=T("library",X),m="/__mockup/images/aerodynamix/",c=[{file:"run-3.jpg",name:"Run 3",note:"Endless momentum",tag:"Fast start",tint:"#d8f2ff"},{file:"drive-mad.jpg",name:"Drive Mad",note:"Unreasonably fun driving",tag:"Popular",tint:"#ffe4d8"},{file:"papaspizzeria.png",name:"Papa's Pizzeria",note:"Take the next order",tag:"Time well spent",tint:"#fff0b8"},{file:"supersmashflash.jpg",name:"Super Smash Flash",note:"Pick your fighter",tag:"Multiplayer",tint:"#e6ddff"}],o=[["run-3.jpg","Run 3"],["drive-mad.jpg","Drive Mad"],["retro-bowl.jpg","Retro Bowl"],["slope.jpg","Slope"],["mc.png","Minecraft"],["supersmashflash.jpg","Super Smash Flash"],["papaspizzeria.png","Papa's Pizzeria"],["papasfreezeria.png","Papa's Freezeria"],["papas-pancakeria.png","Papa's Pancakeria"],["papas-bakeria.png","Papa's Bakeria"],["meat-boy.png","Meat Boy"],["newgrounds-rumble.png","Newgrounds Rumble"],["we-become-what-we-behold.png","We Become What We Behold"],["bad-time-simulator.png","Bad Time Simulator"],["deltarune.png","Deltarune"],["adventure-capitalist.png","Adventure Capitalist"],["fridaynightfunkin.png","Friday Night Funkin'"],["run-2.png","Run 2"],["picoschool.png","Pico's School"],["worldshardestgame.png","World's Hardest Game"],["sandboxels.png","Sandboxels"],["alien-hominid.png","Alien Hominid"],["subway-surfers-sf.jpg","Subway Surfers San Francisco"],["hobo-1.png","Hobo 1"],["hobo-2.png","Hobo 2"],["hobo-3.png","Hobo 3"],["hobo-4.png","Hobo 4"],["hobo-5.png","Hobo 5"],["hobo-6.png","Hobo 6"],["hobo-7.png","Hobo 7"],["gladihoppers.jpg","Gladihoppers"],["fruit-ninja.png","Fruit Ninja"],["binding-of-isaac.png","Binding of Isaac"],["crossy-road.png","Crossy Road"],["cookie-clicker.png","Cookie Clicker"],["duck-life.png","Duck Life"],["geometry-dash-lite.jpg","Geometry Dash Lite"],["doom.png","Doom"],["doki-doki-literature-club.jpg","Doki Doki Literature Club"],["baldis-basics-classic-remastered.png","Baldi's Basics Classic Remastered"],["stickmin-breaking-bank.jpg","Breaking the Bank"],["stickmin-escaping-prison.avif","Escaping the Prison"],["stickmin-stealing-diamond.avif","Stealing the Diamond"],["stickmin-infiltrating-airship.avif","Infiltrating the Airship"],["stickmin-fleeing-complex.avif","Fleeing the Complex"],["greatest-game-square.svg","THE GREATEST GAME OF ALL TIME"],["nubbys-number-factory.jpg","Nubby's Number Factory"]],U=["All games","Quick play","Classics","Odd little gems"];function K({label:p,onClick:d,quiet:l=!1}){return a.jsxs("button",{type:"button",className:`calm-play-button ${l?"calm-play-button--quiet":""}`,onClick:d,"aria-label":p,children:[a.jsx(u,{size:l?14:16,fill:"currentColor",strokeWidth:2.2}),!l&&a.jsx("span",{children:"Play now"})]})}function pa(){const[p,d]=i.useState(""),[l,S]=i.useState("All games"),[g,b]=i.useState(!1),[C,M]=i.useState(!1),[P,F]=i.useState(["Run 3"]),[n,v]=i.useState(null),[k,j]=i.useState(!1),[A,$]=i.useState(72),[w,B]=i.useState(!1),[h,G]=i.useState(!0),f=i.useMemo(()=>{const e=p.trim().toLowerCase();return o.filter(([,r],t)=>{const s=r.toLowerCase().includes(e),D=l==="All games"||l==="Quick play"&&t<12||l==="Classics"&&t>=12&&t<25||l==="Odd little gems"&&t>=25;return s&&D})},[l,p]),R=e=>{F(r=>r.includes(e)?r.filter(t=>t!==e):[...r,e])},x=e=>{v(e),j(!1)},N=e=>{const r=o.findIndex(([,s])=>s===n),t=r<0?0:e==="next"?(r+1)%o.length:(r-1+o.length)%o.length;x(o[t][1])};return a.jsxs("main",{className:"calm-page",children:[a.jsx("style",{children:`
      ...
      `}),a.jsx("nav",{className:"calm-nav","aria-label":"Aerodynamix navigation",children:a.jsxs("div",{className:"calm-shell calm-nav-inner",children:[a.jsxs("button",{className:"calm-wordmark",type:"button",onClick:()=>window.scrollTo({top:0,behavior:"smooth"}),"aria-label":"Return to Aerodynamix home",children:[a.jsx("img",{src:`${m}logo.gif`,alt:""}),a.jsxs("strong",{children:[a.jsx("span",{children:"A"}),"ERODYNAMIX"]})]}),a.jsxs("div",{className:`calm-nav-links ${g?"is-open":""}`,children:[["Games","Apps","Media Player","Connect"].map((e,r)=>a.jsx("button",{type:"button",className:r===0?"is-active":"",onClick:()=>b(!1),children:e},e)),a.jsxs("button",{type:"button",onClick:()=>{M(e=>!e),b(!1)},children:[a.jsx(E,{size:13})," Settings"]})]}),a.jsxs("button",{className:"calm-menu-button",type:"button",onClick:()=>b(e=>!e),"aria-expanded":g,"aria-label":"Toggle navigation menu",children:[g?a.jsx(y,{size:15}):a.jsx(H,{size:15})," ",g?"Close":"Menu"]})]})}),C&&a.jsxs("section",{className:"calm-settings-panel","aria-label":"Settings panel",children:[a.jsx("h3",{children:"Small preferences"}),a.jsxs("div",{className:"calm-setting-line",children:[a.jsx("span",{children:"Reduce motion"}),a.jsx("button",{className:`calm-toggle ${w?"is-on":""}`,type:"button","aria-label":"Toggle reduce motion","aria-pressed":w,onClick:()=>B(e=>!e)})]}),a.jsxs("div",{className:"calm-setting-line",children:[a.jsx("span",{children:"Show favorites first"}),a.jsx("button",{className:`calm-toggle ${h?"is-on":""}`,type:"button","aria-label":"Toggle favorites first","aria-pressed":h,onClick:()=>G(e=>!e),children:h&&a.jsx(I,{size:11,color:"white"})})]}),a.jsxs("div",{className:"calm-setting-line",children:[a.jsx("span",{children:"Library layout"}),a.jsx("strong",{children:"Grid"})]})]}),a.jsxs("div",{className:"calm-shell calm-main",children:[a.jsxs("div",{className:"calm-kicker",children:[a.jsx(O,{size:13})," A quieter way to play"]}),a.jsxs("header",{className:"calm-hero-head",children:[a.jsxs("h1",{children:["Good games,",a.jsx("br",{}),a.jsx("em",{children:"no searching required."})]}),a.jsx("p",{className:"calm-hero-copy",children:"A private-feeling corner of the internet for the games you already love — and the ones you are about to."})]}),a.jsx("section",{"aria-labelledby":"spotlight-title",children:a.jsxs("div",{className:"calm-featured",children:[a.jsxs("article",{className:"calm-featured-main",children:[a.jsx("img",{src:`${m}${c[0].file}`,alt:c[0].name}),a.jsxs("div",{className:"calm-featured-content",children:[a.jsxs("div",{children:[a.jsxs("span",{className:"calm-featured-pill",children:["Featured · ",c[0].tag]}),a.jsx("h2",{id:"spotlight-title",children:c[0].name}),a.jsx("p",{children:c[0].note})]}),a.jsxs("button",{className:"calm-featured-play",type:"button",onClick:()=>x(c[0].name),children:[a.jsx(u,{size:15,fill:"currentColor"})," Play"]})]})]}),a.jsx("div",{className:"calm-featured-side","aria-label":"More featured games",children:c.slice(1).map(e=>a.jsxs("article",{className:"calm-mini-card",children:[a.jsx("img",{src:`${m}${e.file}`,alt:e.name}),a.jsx("button",{type:"button",className:"calm-play-button calm-play-button--quiet",onClick:()=>x(e.name),"aria-label":`Play ${e.name}`,children:a.jsx(u,{size:14,fill:"currentColor"})}),a.jsx("span",{children:e.name})]},e.name))})]})}),a.jsxs("section",{className:"calm-library","aria-labelledby":"library-title",children:[a.jsxs("div",{className:"calm-library-top",children:[a.jsxs("div",{children:[a.jsx("p",{className:"calm-section-label",children:"The full collection"}),a.jsx("h2",{id:"library-title",children:"Find your next game"}),a.jsxs("div",{className:"calm-library-meta",children:[a.jsx(J,{size:13})," ",f.length," titles ready to play"]})]}),a.jsxs("label",{className:"calm-search",children:[a.jsx(z,{size:16}),a.jsx("input",{value:p,onChange:e=>d(e.target.value),type:"search",placeholder:"Search the library","aria-label":"Search games"}),p&&a.jsx("button",{type:"button",onClick:()=>d(""),"aria-label":"Clear search",children:a.jsx(y,{size:14})})]})]}),a.jsxs("div",{className:"calm-filter-row","aria-label":"Filter games",children:[a.jsx(Y,{size:14,color:"#9aaabd","aria-hidden":"true"}),U.map(e=>a.jsxs("button",{type:"button",className:`calm-filter ${l===e?"is-active":""}`,onClick:()=>S(e),children:[e,e==="All games"&&a.jsx("span",{className:"calm-filter-count",children:o.length})]},e)),a.jsxs("span",{style:{marginLeft:"auto",display:"inline-flex",alignItems:"center",gap:6,color:"#9aaabd",fontSize:10,whiteSpace:"nowrap"},children:[a.jsx(V,{size:13})," Curated grid"]})]}),a.jsxs("div",{className:"calm-game-grid",children:[f.map(([e,r],t)=>{const s=P.includes(r);return a.jsxs("article",{className:"calm-game-card",children:[a.jsxs("div",{className:"calm-game-art",children:[a.jsx("img",{src:`${m}${e}`,alt:r,loading:t<12?"eager":"lazy"}),a.jsx("button",{className:`calm-favorite ${s?"is-loved":""}`,type:"button",onClick:()=>R(r),"aria-label":`${s?"Remove":"Add"} ${r} ${s?"from":"to"} favorites`,"aria-pressed":s,children:a.jsx(L,{size:13,fill:s?"currentColor":"none"})}),a.jsx("div",{className:"calm-game-hover",children:a.jsx(K,{label:`Play ${r}`,onClick:()=>x(r),quiet:!0})})]}),a.jsx("span",{className:"calm-game-name",title:r,children:r}),a.jsx("span",{className:"calm-game-type",children:t%3===0?"Arcade":t%3===1?"Classic":"Browser game"})]},e)}),f.length===0&&a.jsx("div",{className:"calm-empty",children:a.jsxs("div",{children:[a.jsx(z,{size:20,color:"#9aaabd"}),a.jsx("strong",{children:"No games in that corner."}),a.jsx("span",{children:"Try a different title or clear the filter."})]})})]})]})]}),a.jsx("aside",{className:"calm-player","aria-label":"Persistent media player",children:a.jsxs("div",{className:"calm-shell calm-player-inner",children:[a.jsxs("div",{className:"calm-track",children:[a.jsx("img",{className:"calm-track-art",src:`${m}${n?o.find(([,e])=>e===n)?.[0]??"logo.gif":"logo.gif"}`,alt:""}),a.jsxs("div",{className:"calm-track-meta",children:[a.jsx("strong",{children:n??"Nothing queued"}),a.jsx("span",{children:n?"Game session":"Media Player · ready when you are"})]})]}),a.jsxs("div",{className:"calm-player-controls",children:[a.jsx("button",{type:"button","aria-label":"Previous track",onClick:()=>N("previous"),children:a.jsx(W,{size:16})}),a.jsx("button",{className:"calm-player-main",type:"button","aria-label":k?"Resume media":"Pause media",onClick:()=>j(e=>!e),children:k?a.jsx(u,{size:15,fill:"currentColor"}):a.jsx(_,{size:15,fill:"currentColor"})}),a.jsx("button",{type:"button","aria-label":"Next track",onClick:()=>N("next"),children:a.jsx(Q,{size:16})})]}),a.jsxs("div",{className:"calm-player-progress",children:[a.jsxs("span",{children:["0:00"," / ",n?"—":"0:00"]}),a.jsx("input",{className:"calm-range",type:"range",min:"0",max:"100",defaultValue:"14","aria-label":"Track progress"}),a.jsxs("div",{className:"calm-volume",children:[a.jsx(q,{size:14}),a.jsx("input",{className:"calm-range",type:"range",min:"0",max:"100",value:A,onChange:e=>$(Number(e.target.value)),"aria-label":"Volume"})]}),a.jsx("button",{type:"button","aria-label":"Close media player",onClick:()=>v(null),style:{display:"grid",placeItems:"center",border:0,color:"#8493a5",background:"transparent",cursor:"pointer"},children:a.jsx(y,{size:14})})]})]})})]})}export{pa as CalmLibrary};
